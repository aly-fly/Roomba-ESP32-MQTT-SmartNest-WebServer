...
#define FIRMWARE_VERSION "Roomba_v0.4"  // Custom name for this program
#define WIFI_CONNECT_TIMEOUT_SEC 30  // How long to wait for WiFi, then switch to Access Point
...
#define MQTT_PASSWORD "  *** your SmartNest password *** "               // Password from Smartnest (or API key)
#define MQTT_CLIENT "  *** your SmartNest Vacuum cleaner Device ID *** "                // Device Id from smartnest
